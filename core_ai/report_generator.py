...
def generate_report(session_id: str, daos: List[DAO]) -> Dict[str, Any]:
    ...
    report = {
        ...
        "flagged_decisions": [
            {
                ...
                # AI analysis block
                "ai_analysis": {
                    "action_summary":     dao.ai_action_summary,
                    "compliance_status":  dao.ai_compliance_status,
                    "risk_level":         dao.ai_risk_level,
                    "category":           dao.ai_category,
                    "issue_detected":     dao.ai_issue_detected,
                    "explanation":        dao.ai_explanation,
                    "recommended_action": dao.ai_recommended_action,
                    "confidence_score":   dao.ai_confidence_score,
                } if dao.ai_explanation else None,
            }
            for dao in flagged
        ],
        ...
        "rbi_response_block": {
            ...
            # AI-generated categories found across session
            "risk_categories_detected": list(set(
                d.ai_category for d in daos
                if d.ai_category and d.ai_issue_detected
            )),

            # All unique recommended actions from AI
            "ai_recommended_actions": list(set(
                d.ai_recommended_action for d in daos
                if d.ai_recommended_action
            )),

            "note": (
                "This report was auto-generated by AgentBridge. "
                "All decisions are logged, timestamped, and mapped against "
                "the RBI FREE-AI Framework. AI-assisted compliance analysis "
                "was performed using a dedicated compliance engine. "
                "Flagged decisions are listed with full input, reasoning, "
                "output, risk classification, and CCO-ready explanations."
            ),
        },
    }
